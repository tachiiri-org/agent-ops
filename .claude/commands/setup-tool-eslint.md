...
- Use `/home/tachiiri/.guide/tools/eslint.md` as the authority for ESLint adoption and version selection.
...
3. Read `/home/tachiiri/.guide/tools/eslint.md` for the ESLint baseline when reconciling package versions
4. Ensure the repository includes the ESLint version selected in `/home/tachiiri/.guide/tools/eslint.md`

...
- Use `/home/tachiiri/.guide/tools/pytest.md` as the authority for Python test tool selection.
...
2. Read `/home/tachiiri/.guide/tools/pytest.md` for the Python test baseline

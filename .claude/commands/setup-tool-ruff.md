...
- Use `/home/tachiiri/.guide/tools/ruff.md` as the authority for Python format and lint tool selection.
...
2. Read `/home/tachiiri/.guide/tools/ruff.md` for the Python lint baseline

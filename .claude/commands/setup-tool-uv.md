...
- Use `/home/tachiiri/.guide/tools/uv.md` as the authority for Python package-management tool selection.
...
2. Read `/home/tachiiri/.guide/tools/uv.md` for the Python package-management baseline

---
name: onboarding
description: "Run repository onboarding workflow: sync guidance files, inspect git state, classify role and runtime, and load the minimum guidance needed to understand the project."
---

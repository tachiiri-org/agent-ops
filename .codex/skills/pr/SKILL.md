---
name: pr
description: "Create a safe pull request flow: ensure branch hygiene, commit staged changes, push to remote, and open a PR to dev; optionally deploy staging for TS Worker projects."
---

---
name: refactor
description: "Run a principle-driven refactor workflow: onboarding context, role-based planning, user-approved steps, incremental implementation, and final commit without creating a PR."
---

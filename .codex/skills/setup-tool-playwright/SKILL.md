...
3. Read `/home/tachiiri/.guide/tools/playwright.md` for the Playwright baseline when reconciling package versions
4. Ensure the repository includes the Playwright version selected in `/home/tachiiri/.guide/tools/playwright.md`

...
Auth0 provider profile for repositories and services that use Auth0 as an external identity provider.
...
- Keep provider-agnostic semantics in `../domains/identity-and-access.md`.
- Keep client authentication patterns in `../domains/interaction-edges.md`.
- Keep BFF browser-boundary responsibilities in `../roles/bff.md`.
